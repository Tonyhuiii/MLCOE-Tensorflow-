...
class SSSDS4Imputer(keras.Model):
    ...
    def call(self, input_data):
        ...
        noise, conditional, train_mask, loss_mask, diffusion_steps = input_data 
        # mask=tf.cast(mask,dtype=tf.float32)
        conditional = conditional * train_mask
        conditional = tf.concat([conditional, train_mask], axis=1)
